...
function Hero() {
  return (
      <div className="hero text-center flex justify-center align-middle flex-col" id='hero'>
        ...
        <h2 className='pb-10 text-xl text-gray-100'>Leads Unlocked Every Month: Your Renovation Business Key</h2>
        <a href='#services' className='button bg-gray-200 p-5 rounded-2xl w-32 flex justify-center self-center'>Get to know us better</a>
          </div>
        </Parallax>
